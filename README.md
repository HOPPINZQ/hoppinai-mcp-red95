...
dotnet build
```
> 💡 提示：C#运行环境dotnet建议可以安装Visual Studio的C#相关内容
...
或者在源代码的CmdTools文件夹内将OPENRA_PATH替换为OpenRA文件夹的绝对路径：
```java
@Service
